    ...
    const invoiceHTML = `
      <div style="font-family: Georgia, serif; padding: 60px 40px; max-width: 500px; margin: 0 auto; background: #fff;">
        <div style="text-align: center; margin-bottom: 40px; border-bottom: 1px solid #e5e5e5; padding-bottom: 30px;">
          <h1 style="font-size: 24px; font-weight: normal; letter-spacing: 2px; margin: 0; color: #333;">CARPINTERÍA PLACITO</h1>
          <p style="color: #888; font-style: italic; margin: 5px 0 0 0;">Desde 1982</p>
        </div>
    ...
    <div className="min-h-screen bg-stone-50 py-12 px-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-stone-400 text-sm italic">Desde 1982</p>
        </div>
